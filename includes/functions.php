<?php
	...
	function find_default_page_for_subject($subject_id){
		...
		if($firstpage = mysqli_fetch_assoc($page_set)){
			return $firstpage;
		}else{
			return null;
		}
	...
	function find_selected_page($public=false){
		//creating global variables so they remain global when they leave
	...
	function attempt_login($username, $password){
		...
		if($admin){
			...
			if(password_check($password, $admin["hashed_passwords"])){
				//password matches
				return $admin;
			}else{
